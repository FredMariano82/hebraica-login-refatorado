        ...
        <Card className="shadow-lg border-0">
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
              ...
              <Card className="border-green-200 bg-green-50">
                <CardContent className="p-4 text-center">
                  ...
                  <div className="text-2xl font-bold text-green-700">{statusCounts.ok}</div>
              ...
              <Card className="border-orange-200 bg-orange-50">
                <CardContent className="p-4 text-center">
                  ...
                  <div className="text-2xl font-bold text-orange-700">{statusCounts.urgente}</div>
              ...
              <Card className="border-red-200 bg-red-50">
                <CardContent className="p-4 text-center">
                  ...
                  <div className="text-2xl font-bold text-red-700">{statusCounts.negada}</div>
                  <div className="text-sm text-red-600">Negadas</div>
                </CardContent>
              </Card>
            </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-red-50">
                    ...
                    <TableHead className="font-semibold text-red-800 text-center">Status Liberação</TableHead>
                    <TableHead className="font-semibold text-red-800 text-center">Data Final</TableHead>
                    <TableHead className="font-semibold text-red-800 text-center">Observações</TableHead>
                    <TableHead className="font-semibold text-red-800 text-center">Ações</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
            ...
            <div className="mt-6 text-sm text-red-600 text-center">
              Mostrando <strong>{totalPrestadores}</strong> prestadores em liberação
            </div>
